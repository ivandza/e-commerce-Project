  ...
  return (
    <div className="navbar">
      <div className="navbarLeftDiv">
        ...
        <h2 className="siteTitle">sneakers</h2>
      ...
      <div className="navbarRightDiv">
        <div className="hoverOver">
          <div className="divForPositon">
            ...
            {props.number !== 0 && (
              <div className="cartStatePopup">{props.number}</div>
            )}
          </div>
              ...
              <div>
                <div className="cartCurrentState">
                  ...
                  <div className="cartProductText">
                    ...
                    <p>
                      $125.00 x {props.number} <b>${props.number * 125}.00</b>
                    </p>{" "}
                  </div>
                  <img src={binIcon} onClick={props.clearBin} alt="delete" />
                </div>
                <center>
